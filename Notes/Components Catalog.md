...
* DropOnDeathComponent: Spawns a scene chosen from weighted paths when HealthComponent reaches zero and removes the Entity, for loot, remains, or replacement creatures.
...
Total listed: 124  
Generated by AI (Codex) on 2026-07-16
