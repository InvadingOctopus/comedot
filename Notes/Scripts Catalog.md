...
* ComponentDependencyMonitor: Editor-only node that checks co-component dependencies in the edited scene without making runtime components @tool.
...
* Start: Main-scene root script that boots Comedot, applies global flags, and can register startup data in GameState.
