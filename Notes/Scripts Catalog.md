...
* Spawner: Base spawning Node that validates and instantiates a configured scene under a resolved parent, with hooks for specialized Spawner subclasses.
...
* RandomSpawner: Spawner subclass that randomly chooses a scene from a configurable list before spawning.
