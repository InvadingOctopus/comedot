...
* OnScreenTrigger: VisibleOnScreenNotifier2D scene that emits a trigger when it enters the viewport, with optional delay, use limits, and deletion after its final trigger.
