...
* TurnState: TimedStateMachine resource defining the turnReady, turnBegin, turnExecute, and turnEnd flow.
...
* Weapon: Starter gun-and-bullet template group with configurable damage and cooldown values for quick weapon prototypes.
