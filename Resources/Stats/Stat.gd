...
## TIP: If you need to use Stats for objects that require floats, such as [member Timer.wait_time] or [member CooldownTimer.cooldownMilliseconds],
...
class_name Stat extends GameplayResourceBase
