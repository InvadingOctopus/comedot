...
@icon("res://Assets/Images/SF Symbols/figure.stand.svg")
...
## This ensures that multiple components which interact with the same node do not perform excessive updates, such as a [PlatformControlComponent[ and a [JumpControlComponent].
